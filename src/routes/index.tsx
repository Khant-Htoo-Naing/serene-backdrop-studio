  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Khant Htoo Naing | Personal Portfolio" },
      {
        ...
        content: "The personal portfolio and story of Khant Htoo Naing.",
      },
...
function Portfolio() {
  return (
    <main className="site-shell">
      ...
      <div className="leaf-line leaf-line-one" aria-hidden="true">
        <Leaf size={54} />
      </div>
      <div className="leaf-line leaf-line-two" aria-hidden="true">
        <Flower2 size={38} />
      </div>
      ...
      <section className="profile-column">
        <div className="topline">
          ...
          <span className="status-dot">
            <span /> Based in Myanmar
          </span>
        </div>

        <div className="intro-copy">
          <p className="kicker">
            <Sparkles size={13} /> A little about me
          </p>
          <h1>
            Khant
            <br />
          ...
          <p className="lead">
            A quiet mind with a warm heart,
            <br />
        ...
        <div
          ...
          aria-label="A collage of personal photographs in a serene forest"
        >
          <div className="collage-sticker sticker-one">
            <SunMedium size={20} />
            <span>
              good
              <br />
          ...
          <div className="collage-sticker sticker-two">
            from
            <br />
            my life
          </div>
        ...
        <div className="identity-strip">
          ...
          <p>
            Ambivert, but more introverted.
            <br />
            <span>Tranquility &amp; serenity.</span>
          </p>
          <p className="identity-side">
            Love
            <br />
            to love.
          </p>
      ...
      <section className="story-column">
        ...
        <div className="story-body">
          ...
          <p className="story-text">
            I’m Khant Htoo Naing — someone who finds meaning in quiet moments, sincere
            relationships, and the steady pursuit of a life that feels true. I believe softness and
            determination can exist in the same person.
          </p>
          ...
          <div className="facts-card">
            ...
            <p className="family-note">
              My father and mother are engineers of chemical and chemistry. My elder sister attends
              TTU and studies civil engineering. My younger brother is a Grade 8 student.
            </p>
          </div>
        </div>
        ...
        <nav className="section-nav" aria-label="More about Khant Htoo Naing">
          {(Object.keys(panels) as PanelKey[]).map((key, index) => {
            ...
            return (
              <Link to={`/${key === "contact" ? "connect" : key}`} className="nav-item" key={key}>
                <span className="nav-number">0{index + 1}</span>
                <span>{item.eyebrow.split(" / ")[1]}</span>
                <Icon size={17} className="nav-icon" />
                <ArrowUpRight size={17} className="arrow-icon" />
              </Link>
            );
          })}
        </nav>
